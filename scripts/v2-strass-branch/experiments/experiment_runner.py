...
if __name__ == "__main__":
    ...
    # Point to your YAML file (make sure the path is correct)
    config_path = os.path.join("Users", "PC", "Desktop", "AI4Good - Brain Project" , "AI4Good-MTL-Group-2","scripts","v2-strass-branch","configs", "experiment_config.yaml")  # Adjust this if it's somewhere else

    # Define the experiment and subjects to run
    experiment_name = "baseline"  # Change to "neural_networks" or "advanced" if needed
    subject_ids = ["sub-01"]  # Replace with actual IDs available in your dataset

    # Run the experiment
    runner = ExperimentRunner(config_path)
    results = runner.run_experiment(experiment_name, subject_ids)

    # Save results to disk
    runner.save_experiment_results(results, f"{experiment_name}_results.json")
